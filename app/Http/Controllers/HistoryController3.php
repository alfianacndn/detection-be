...
$history_bydate = history::whereBetween('date',[$request->start_date,$request->end_date])->whereBetween('time',[$request->start_time,$request->end_time])->get();
...
$history_bytime = history::where('date','=',date("d-m-Y"))->whereBetween('time',[$request->start_time,$request->end_time])->get();
